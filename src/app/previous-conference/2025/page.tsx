...
export async function generateMetadata(): Promise<Metadata> {
    try {
        ...
        const canonicalPath = "/previous-conference/2025"; // hardcode since we know this is sessions page
                    ...
                    <div className="auto-container">
                        <div className="content1 wow fadeInUp" data-wow-delay="800ms" data-wow-duration="1000ms">
                            ...
                            <ul>
                                ...
                                <li>
                                    <span>Distinguished Speakers:</span> Our keynote speakers delivered insightful presentations on cutting-edge topics in Pharma, Pharmaceutics and Biotechnology.
                                </li>
                                <li>
